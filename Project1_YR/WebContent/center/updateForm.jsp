...
<textarea name="content" rows="20" cols="80"></textarea></td>
</tr>

<tr>
<td colspan="3" style="text-align: right;">첨부파일</td><td>
<input type="file" name="file" style="text-align: right;"></td>
</tr>
</table>

<div id="table_search">
<!-- // 넘기는 location 페이지 오류 <input type="button" value="글쓰기" class="btn" onclick="location.href='writeForm.jsp'"> -->
<!-- // 불필요한 코드 삭제 <input type="submit" value="글쓰기" class="btn" onclick="location.href='notice.jsp'"> -->
<input type="submit" value="글수정" class="btn" onclick="location.href='notice.jsp'">
